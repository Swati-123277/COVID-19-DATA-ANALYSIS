...
where continent is null group by location order by total_deaths desc;
...
select "CovidDeaths".location,"CovidVaccinations".aged_65_older from "CovidDeaths"
...
from "CovidDeaths" inner join "CovidVaccinations" on "CovidDeaths".iso_code="CovidVaccinations".iso_code
and "CovidDeaths".date="CovidVaccinations".date  group by "CovidVaccinatios".location;
...
from "CovidDeaths" join "CovidVaccinations" on "CovidDeaths".iso_code="CovidVaccinations".iso_code
and "CovidDeaths".date="CovidVaccinations".date
